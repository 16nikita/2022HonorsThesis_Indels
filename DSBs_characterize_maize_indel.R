...
DSB_randDSBs<-read.delim("DSB_coldspotsv4.bed")
DSB_cold_2kb_up<-read.delim("DSB_cold_2kb_up.bed")
DSB_cold_2kb_down<-read.delim("DSB_cold_2kb_down.bed")

#Where are DSBs:
DSB_loc<-read.delim("where_are_DSB.txt",sep='\t', header = FALSE)[-c(4:5)]
colnames(DSB_loc) <- c('chrom', 'start', 'end','B_chrom', 'B_start', 'B_end','type','overlap in bp')
randDSB_loc<-read.delim("where_are_randDSB.txt",sep='\t', header = FALSE)
colnames(randDSB_loc) <- c('chrom', 'start', 'end','B_chrom', 'B_start', 'B_end','type','overlap in bp')
gene_DSB<-DSB_loc[which(DSB_loc$type=='gene'),]
TSS_DSB<-DSB_loc[which(DSB_loc$type=='TSS'),]
TTS_DSB<-DSB_loc[which(DSB_loc$type=='TTS'),]
gene_randDSB<-randDSB_loc[which(randDSB_loc$type=='gene'),]
TSS_randDSB<-randDSB_loc[which(randDSB_loc$type=='TSS'),]
TTS_randDSB<-randDSB_loc[which(randDSB_loc$type=='TTS'),]
write.table(gene_DSB[c(1:3)],file="gene_DSB.bed",row.names = F,quote=FALSE, sep = '\t')
write.table(TSS_DSB[c(1:3)],file="TSS_DSB.bed",row.names = F,quote=FALSE, sep = '\t')
write.table(TTS_DSB[c(1:3)],file="TTS_DSB.bed",row.names = F,quote=FALSE, sep = '\t')
write.table(gene_randDSB[c(1:3)],file="gene_randDSB.bed",row.names = F,quote=FALSE, sep = '\t')
write.table(TSS_randDSB[c(1:3)],file="TSS_randDSB.bed",row.names = F,quote=FALSE, sep = '\t')
write.table(TTS_randDSB[c(1:3)],file="TTS_randDSB.bed",row.names = F,quote=FALSE, sep = '\t')

##READ IN INTERSECT DATA:
# INTERSECT WITH PREDICTED CO REGIONS
{
  intersect_pred<-read.delim("intersect_gene_DSB.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_pred<-read.delim("intersect_10bp_gene_DSB.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_pred<-read.delim("intersect_20bp_gene_DSB.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_pred<-read.delim("intersect_30bp_gene_DSB.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_pred<-read.delim("intersect_40bp_gene_DSB.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_pred<-read.delim("intersect_50bp_gene_DSB.txt",sep='\t', header = FALSE)
  ...
  intersect_2kbup_pred<-read.delim("intersect_TSS_DSB.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_2kbup_pred<-read.delim("intersect_10bp_TSS_DSB.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_2kbup_pred<-read.delim("intersect_20bp_TSS_DSB.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_2kbup_pred<-read.delim("intersect_30bp_TSS_DSB.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_2kbup_pred<-read.delim("intersect_40bp_TSS_DSB.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_2kbup_pred<-read.delim("intersect_50bp_TSS_DSB.txt",sep='\t', header = FALSE)
  ...
  intersect_2kbdown_pred<-read.delim("intersect_TTS_DSB.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_2kbdown_pred<-read.delim("intersect_10bp_TTS_DSB.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_2kbdown_pred<-read.delim("intersect_20bp_TTS_DSB.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_2kbdown_pred<-read.delim("intersect_30bp_TTS_DSB.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_2kbdown_pred<-read.delim("intersect_40bp_TTS_DSB.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_2kbdown_pred<-read.delim("intersect_40bp_TTS_DSB.txt",sep='\t', header = FALSE)
...
{
  intersect_cold_pred<-read.delim("intersect_gene_randDSB.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_cold_pred<-read.delim("intersect_10bp_gene_randDSB.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_cold_pred<-read.delim("intersect_20bp_gene_randDSB.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_cold_pred<-read.delim("intersect_30bp_gene_randDSB.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_cold_pred<-read.delim("intersect_40bp_gene_randDSB.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_cold_pred<-read.delim("intersect_50bp_gene_randDSB.txt",sep='\t', header = FALSE)
  ...
  intersect_2kbup_cold_pred<-read.delim("intersect_TSS_randDSB.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_2kbup_cold_pred<-read.delim("intersect_10bp_TSS_randDSB.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_2kbup_cold_pred<-read.delim("intersect_20bp_TSS_randDSB.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_2kbup_cold_pred<-read.delim("intersect_30bp_TSS_randDSB.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_2kbup_cold_pred<-read.delim("intersect_40bp_TSS_randDSB.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_2kbup_cold_pred<-read.delim("intersect_50bp_TSS_randDSB.txt",sep='\t', header = FALSE)
  ...
  intersect_2kbdown_cold_pred<-read.delim("intersect_TTS_randDSB.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_2kbdown_cold_pred<-read.delim("intersect_10bp_TTS_randDSB.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_2kbdown_cold_pred<-read.delim("intersect_20bp_TTS_randDSB.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_2kbdown_cold_pred<-read.delim("intersect_30bp_TTS_randDSB.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_2kbdown_cold_pred<-read.delim("intersect_40bp_TTS_randDSB.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_2kbdown_cold_pred<-read.delim("intersect_40bp_TTS_randDSB.txt",sep='\t', header = FALSE)
...
{
intersect_overlap<-percentage_overlap(intersect_pred,DSBs_2)
intersect_10bp_overlap<-percentage_overlap(intersect_10bp_pred,DSBs_2)
intersect_20bp_overlap<-percentage_overlap(intersect_20bp_pred,DSBs_2)
intersect_30bp_overlap<-percentage_overlap(intersect_30bp_pred,DSBs_2)
intersect_40bp_overlap<-percentage_overlap(intersect_40bp_pred,DSBs_2)
intersect_50bp_overlap<-percentage_overlap(intersect_50bp_pred,DSBs_2)

intersect_2kbup_overlap<-percentage_overlap(intersect_2kbup_pred,DSBs_2_2kbup)
intersect_10bp_2kbup_overlap<-percentage_overlap(intersect_10bp_2kbup_pred,DSBs_2_2kbup)
intersect_20bp_2kbup_overlap<-percentage_overlap(intersect_20bp_2kbup_pred,DSBs_2_2kbup)
intersect_30bp_2kbup_overlap<-percentage_overlap(intersect_30bp_2kbup_pred,DSBs_2_2kbup)
intersect_40bp_2kbup_overlap<-percentage_overlap(intersect_40bp_2kbup_pred,DSBs_2_2kbup)
intersect_50bp_2kbup_overlap<-percentage_overlap(intersect_50bp_2kbup_pred,DSBs_2_2kbup)

intersect_2kbdown_overlap<-percentage_overlap(intersect_2kbdown_pred,DSBs_2_2kbdown)
intersect_10bp_2kbdown_overlap<-percentage_overlap(intersect_10bp_2kbdown_pred,DSBs_2_2kbdown)
intersect_20bp_2kbdown_overlap<-percentage_overlap(intersect_20bp_2kbdown_pred,DSBs_2_2kbdown)
intersect_30bp_2kbdown_overlap<-percentage_overlap(intersect_30bp_2kbdown_pred,DSBs_2_2kbdown)
intersect_40bp_2kbdown_overlap<-percentage_overlap(intersect_40bp_2kbdown_pred,DSBs_2_2kbdown)
intersect_50bp_2kbdown_overlap<-percentage_overlap(intersect_50bp_2kbdown_pred,DSBs_2_2kbdown)

intersect_cold_overlap<-percentage_overlap(intersect_cold_pred,DSB_random)
intersect_10bp_cold_overlap<-percentage_overlap(intersect_10bp_cold_pred,DSB_random)
intersect_20bp_cold_overlap<-percentage_overlap(intersect_20bp_cold_pred,DSB_random)
intersect_30bp_cold_overlap<-percentage_overlap(intersect_30bp_cold_pred,DSB_random)
intersect_40bp_cold_overlap<-percentage_overlap(intersect_40bp_cold_pred,DSB_random)
intersect_50bp_cold_overlap<-percentage_overlap(intersect_50bp_cold_pred,DSB_random)

intersect_2kbup_cold_overlap<-percentage_overlap(intersect_2kbup_cold_pred,DSB_random_2kb_up)
intersect_10bp_2kbup_cold_overlap<-percentage_overlap(intersect_10bp_2kbup_cold_pred,DSB_random_2kb_up)
intersect_20bp_2kbup_cold_overlap<-percentage_overlap(intersect_20bp_2kbup_cold_pred,DSB_random_2kb_up)
intersect_30bp_2kbup_cold_overlap<-percentage_overlap(intersect_30bp_2kbup_cold_pred,DSB_random_2kb_up)
intersect_40bp_2kbup_cold_overlap<-percentage_overlap(intersect_40bp_2kbup_cold_pred,DSB_random_2kb_up)
intersect_50bp_2kbup_cold_overlap<-percentage_overlap(intersect_50bp_2kbup_cold_pred,DSB_random_2kb_up)

intersect_2kbdown_cold_overlap<-percentage_overlap(intersect_2kbdown_cold_pred,DSB_random_2kb_down)
intersect_10bp_2kbdown_cold_overlap<-percentage_overlap(intersect_10bp_2kbdown_cold_pred,DSB_random_2kb_down)
intersect_20bp_2kbdown_cold_overlap<-percentage_overlap(intersect_20bp_2kbdown_cold_pred,DSB_random_2kb_down)
intersect_30bp_2kbdown_cold_overlap<-percentage_overlap(intersect_30bp_2kbdown_cold_pred,DSB_random_2kb_down)
intersect_40bp_2kbdown_cold_overlap<-percentage_overlap(intersect_40bp_2kbdown_cold_pred,DSB_random_2kb_down)
intersect_50bp_2kbdown_cold_overlap<-percentage_overlap(intersect_50bp_2kbdown_cold_pred,DSB_random_2kb_down)
}
...
#BARGRAPHS - for each: change TITLE, INDEL SIZES, LEGEND, AXIS TITLE POSITION
{
  ...
  perc<-ggplot(full_data, aes(fill=intersect,x=intersect,y=value)) +
    ...
    scale_fill_manual(values = c("Gene" = "sandybrown",
                                 "TSS" = "deepskyblue",
                                 "TTS" = 'palegreen'))+
    ggtitle("Small Indel Density on DSB's in Gene/TSS/TTS") +
...
plot(intersect_overlap_plot$B_start/1000000,intersect_overlap_plot$percent,type="p",main="Chromosome 1 DSBs & Indel Densities",xlab="DSB Position (Mb)",ylab="Density (indels/bp)")
intersect_overlap_plot<-intersect_overlap[which(intersect_overlap$B_chrom==2),]
plot(intersect_overlap_plot$B_start/1000000,intersect_overlap_plot$percent,type="p",main="Chromosome 2 DSBs & Indel Densities",xlab="DSB Position (Mb)",ylab="Density (indels/bp)")
intersect_overlap_plot<-intersect_overlap[which(intersect_overlap$B_chrom==3),]
plot(intersect_overlap_plot$B_start/1000000,intersect_overlap_plot$percent,type="p",main="Chromosome 3 DSBs & Indel Densities",xlab="DSB Position (Mb)",ylab="Density (indels/bp)")
intersect_overlap_plot<-intersect_overlap[which(intersect_overlap$B_chrom==4),]
plot(intersect_overlap_plot$B_start/1000000,intersect_overlap_plot$percent,type="p",main="Chromosome 4 DSBs & Indel Densities",xlab="DSB Position (Mb)",ylab="Density (indels/bp)")
intersect_overlap_plot<-intersect_overlap[which(intersect_overlap$B_chrom==5),]
plot(intersect_overlap_plot$B_start/1000000,intersect_overlap_plot$percent,type="p",main="Chromosome 5 DSBs & Indel Densities",xlab="DSB Position (Mb)",ylab="Density (indels/bp)")
intersect_overlap_plot<-intersect_overlap[which(intersect_overlap$B_chrom==6),]
plot(intersect_overlap_plot$B_start/1000000,intersect_overlap_plot$percent,type="p",main="Chromosome 6 DSBs & Indel Densities",xlab="DSB Position (Mb)",ylab="Density (indels/bp)")
intersect_overlap_plot<-intersect_overlap[which(intersect_overlap$B_chrom==7),]
plot(intersect_overlap_plot$B_start/1000000,intersect_overlap_plot$percent,type="p",main="Chromosome 7 DSBs & Indel Densities",xlab="DSB Position (Mb)",ylab="Density (indels/bp)")
intersect_overlap_plot<-intersect_overlap[which(intersect_overlap$B_chrom==8),]
plot(intersect_overlap_plot$B_start/1000000,intersect_overlap_plot$percent,type="p",main="Chromosome 8 DSBs & Indel Densities",xlab="DSB Position (Mb)",ylab="Density (indels/bp)")
intersect_overlap_plot<-intersect_overlap[which(intersect_overlap$B_chrom==9),]
plot(intersect_overlap_plot$B_start/1000000,intersect_overlap_plot$percent,type="p",main="Chromosome 9 DSBs & Indel Densities",xlab="DSB Position (Mb)",ylab="Density (indels/bp)")
intersect_overlap_plot<-intersect_overlap[which(intersect_overlap$B_chrom==10),]
plot(intersect_overlap_plot$B_start/1000000,intersect_overlap_plot$percent,type="p",main="Chromosome 10 DSBs & Indel Densities",xlab="DSB Position (Mb)",ylab="Density (indels/bp)")
...
intersect_overlap_plot<-ggplot(intersect_overlap_plot, aes(x=B_start/1000000, y=percent)) + geom_bar(stat="identity", width=3, fill="steelblue")+
  theme_minimal() + labs(title="Chromosome 1 Indel Densities at Outlier DSBs", 
                         x="DSB Position (Mb)", y = "Deletion Density (Indels/bp)")+  expand_limits(x = c(0,max_temp))
saveRDS(intersect_overlap_plot,file = "outlier_DSB_1.rds")
...
intersect_overlap_plot<-ggplot(intersect_overlap_plot, aes(x=B_start/1000000, y=percent)) + geom_bar(stat="identity", width=3, fill="steelblue")+
  theme_minimal() + labs(title="Chromosome 2 Indel Densities at Outlier DSBs", 
                         x="DSB Position (Mb)", y = "Deletion Density (Indels/bp)")+  expand_limits(x = c(0,max_temp))
saveRDS(intersect_overlap_plot,file = "outlier_DSB_2.rds")
...
intersect_overlap_plot<-ggplot(intersect_overlap_plot, aes(x=B_start/1000000, y=percent)) + geom_bar(stat="identity", width=2, fill="steelblue")+
  theme_minimal() + labs(title="Chromosome 3 Indel Densities at Outlier DSBs", 
                         x="DSB Position (Mb)", y = "Deletion Density (Indels/bp)")+ expand_limits(x = c(0,max_temp))
saveRDS(intersect_overlap_plot,file = "outlier_DSB_3.rds")
...
intersect_overlap_plot<-ggplot(intersect_overlap_plot, aes(x=B_start/1000000, y=percent)) + geom_bar(stat="identity", width=3, fill="steelblue")+
  theme_minimal() + labs(title="Chromosome 4 Indel Densities at Outlier DSBs", 
                         x="DSB Position (Mb)", y = "Deletion Density (Indels/bp)")+ expand_limits(x = c(0,max_temp))
saveRDS(intersect_overlap_plot,file = "outlier_DSB_4.rds")
...
intersect_overlap_plot<-ggplot(intersect_overlap_plot, aes(x=B_start/1000000, y=percent)) + geom_bar(stat="identity", width=3, fill="steelblue")+
  theme_minimal() + labs(title="Chromosome 5 Indel Densities at Outlier DSBs", 
                         x="DSB Position (Mb)", y = "Deletion Density (Indels/bp)")+ expand_limits(x = c(0,max_temp))
saveRDS(intersect_overlap_plot,file = "outlier_DSB_5.rds")
...
intersect_overlap_plot<-ggplot(intersect_overlap_plot, aes(x=B_start/1000000, y=percent)) + geom_bar(stat="identity", width=3, fill="steelblue")+
  theme_minimal() + labs(title="Chromosome 6 Indel Densities at Outlier DSBs", 
                         x="DSB Position (Mb)", y = "Deletion Density (Indels/bp)")+ expand_limits(x = c(0,max_temp))
saveRDS(intersect_overlap_plot,file = "outlier_DSB_6.rds")
...
intersect_overlap_plot<-ggplot(intersect_overlap_plot, aes(x=B_start/1000000, y=percent)) + geom_bar(stat="identity", width=3, fill="steelblue")+
  theme_minimal() + labs(title="Chromosome 7 Indel Densities at Outlier DSBs", 
                         x="DSB Position (Mb)", y = "Deletion Density (Indels/bp)")+ expand_limits(x = c(0,max_temp))
saveRDS(intersect_overlap_plot,file = "outlier_DSB_7.rds")
...
intersect_overlap_plot<-ggplot(intersect_overlap_plot, aes(x=B_start/1000000, y=percent)) + geom_bar(stat="identity", width=3, fill="steelblue")+
  theme_minimal() + labs(title="Chromosome 8 Indel Densities at Outlier DSBs", 
                         x="DSB Position (Mb)", y = "Deletion Density (Indels/bp)")+ expand_limits(x = c(0,max_temp))
saveRDS(intersect_overlap_plot,file = "outlier_DSB_8.rds")
...
intersect_overlap_plot<-ggplot(intersect_overlap_plot, aes(x=B_start/1000000, y=percent)) + geom_bar(stat="identity", width=3, fill="steelblue")+
  theme_minimal() + labs(title="Chromosome 9 Indel Densities at Outlier DSBs", 
                         x="DSB Position (Mb)", y = "Deletion Density (Indels/bp)")+ expand_limits(x = c(0,max_temp))
saveRDS(intersect_overlap_plot,file = "outlier_DSB_9.rds")
...
intersect_overlap_plot<-ggplot(intersect_overlap_plot, aes(x=B_start/1000000, y=percent)) + geom_bar(stat="identity", width=2, fill="steelblue")+
  theme_minimal() + labs(title="Chromosome 10 Indel Densities at Outlier DSBs", 
                         x="DSB Position (Mb)", y = "Deletion Density (Indels/bp)")+ expand_limits(x = c(0,max_temp))
saveRDS(intersect_overlap_plot,file = "outlier_DSB_10.rds")
...
}
{
  metaplot<-function(all, all_cold){
    ...
    test2<-unlist(test2)
    plot(smooth.spline(seq(-5000,4999,10),test,spar=0.5),col="red",lwd=1,type="l",ylim=c(0,max),main="Indel Densities at Eli's DSBs",xlab ="Distance from midpoint", ylab="Indel Density (indels/bp)")
    lines(smooth.spline(seq(-5000,4999,10),test2,spar=0.5),col="blue",lwd=1,type="l",main="Indel Densities at Eli's DSBs",xlab ="Distance from midpoint", ylab="Indel Density (indels/bp)")
  ...
  metaplot_2<-function(all, all_cold){
    ...
    test2<-unlist(test2)
    plot(smooth.spline(seq(-10000,9999,100),test,spar=0.5),col="red",lwd=1,type="l",ylim=c(0,max),main="Indel Densities 20kb down from Eli's DSBs",xlab ="Distance from midpoint", ylab="Indel Density (indels/bp)")
    lines(smooth.spline(seq(-10000,9999,100),test2,spar=0.5),col="blue",lwd=1,type="l",main="Indel Densities 20kb down from Eli's DSBs",xlab ="Distance from midpoint", ylab="Indel Density (indels/bp)")
    ...
    test2<-unlist(test2)
    plot(smooth.spline(seq(-10000,9999,100),test,spar=0.5),col="red",lwd=1,type="l",ylim=c(0,max),main="Indel Densities 20kb up from Eli's DSBs",xlab ="Distance from midpoint", ylab="Indel Density (indels/bp)")
    lines(smooth.spline(seq(-10000,9999,100),test2,spar=0.5),col="blue",lwd=1,type="l",main="Indel Densities 20kb up from Eli's DSBs",xlab ="Distance from midpoint", ylab="Indel Density (indels/bp)")
