...
{
  intersect_pred<-read.delim("intersect_aLL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_pred<-read.delim("intersect_10bp_aLL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_pred<-read.delim("intersect_20bp_aLL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_pred<-read.delim("intersect_30bp_aLL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_pred<-read.delim("intersect_40bp_aLL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_pred<-read.delim("intersect_50bp_aLL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_2kbup_pred<-read.delim("intersect_2kbup_aLL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_2kbup_pred<-read.delim("intersect_10bp_2kbup_aLL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_2kbup_pred<-read.delim("intersect_20bp_2kbup_aLL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_2kbup_pred<-read.delim("intersect_30bp_2kbup_aLL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_2kbup_pred<-read.delim("intersect_40bp_2kbup_aLL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_2kbup_pred<-read.delim("intersect_50bp_2kbup_aLL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_2kbdown_pred<-read.delim("intersect_2kbdown_aLL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_2kbdown_pred<-read.delim("intersect_10bp_2kbdown_aLL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_2kbdown_pred<-read.delim("intersect_20bp_2kbdown_aLL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_2kbdown_pred<-read.delim("intersect_30bp_2kbdown_aLL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_2kbdown_pred<-read.delim("intersect_40bp_2kbdown_aLL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_2kbdown_pred<-read.delim("intersect_50bp_2kbdown_aLL_PCO.txt",sep='\t', header = FALSE)
...
{
  intersect_cold_pred<-read.delim("intersect_aLL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_cold_pred<-read.delim("intersect_10bp_aLL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_cold_pred<-read.delim("intersect_20bp_aLL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_cold_pred<-read.delim("intersect_30bp_aLL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_cold_pred<-read.delim("intersect_40bp_aLL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_cold_pred<-read.delim("intersect_50bp_aLL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_2kbup_cold_pred<-read.delim("intersect_2kbup_aLL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_2kbup_cold_pred<-read.delim("intersect_10bp_2kbup_aLL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_2kbup_cold_pred<-read.delim("intersect_20bp_2kbup_aLL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_2kbup_cold_pred<-read.delim("intersect_30bp_2kbup_aLL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_2kbup_cold_pred<-read.delim("intersect_40bp_2kbup_aLL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_2kbup_cold_pred<-read.delim("intersect_50bp_2kbup_aLL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_2kbdown_cold_pred<-read.delim("intersect_2kbdown_aLL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_2kbdown_cold_pred<-read.delim("intersect_10bp_2kbdown_aLL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_2kbdown_cold_pred<-read.delim("intersect_20bp_2kbdown_aLL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_2kbdown_cold_pred<-read.delim("intersect_30bp_2kbdown_aLL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_2kbdown_cold_pred<-read.delim("intersect_40bp_2kbdown_aLL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_2kbdown_cold_pred<-read.delim("intersect_50bp_2kbdown_aLL_randPCO.txt",sep='\t', header = FALSE)
...
#BARGRAPHS - for each: change TITLE, INDEL SIZES, LEGEND, AXIS TITLE POSITION
{
  ...
  perc<-ggplot(full_data1, aes(fill=color,x=levels,y=value)) +
    ...
    ggtitle("Medium Indel Density on Empirical COs") +
...
}
{
  metaplot<-function(all, all_cold){
    ...
    test2<-unlist(test2)
    plot(smooth.spline(seq(-1000,999,100),test,spar=0.6),col="red",lwd=1,type="l",ylim=c(0,max),main="Indel Densities at PCOs",xlab ="Distance from midpoint", ylab="Indel Density (indels/bp)")
    lines(smooth.spline(seq(-1000,999,100),test2,spar=0.6),col="blue",lwd=1,type="l",ylim=c(),main="Indel Densities at PCOs",xlab ="Distance from midpoint", ylab="Indel Density (indels/bp)")
    ...
    test2<-unlist(test2)
    plot(smooth.spline(seq(-1000,999,100),test,spar=0.6),col="red",lwd=1,type="l",ylim=c(0,max),main="Indel Densities 2kb down from PCOs",xlab ="Distance from midpoint", ylab="Indel Density (indels/bp)")
    lines(smooth.spline(seq(-1000,999,100),test2,spar=0.6),col="blue",lwd=1,type="l",ylim=c(),main="Indel Densities 2kb down from PCOs",xlab ="Distance from midpoint", ylab="Indel Density (indels/bp)")
    ...
    test2<-unlist(test2)
    plot(smooth.spline(seq(-1000,999,100),test,spar=0.6),col="red",lwd=1,type="l",ylim=c(0,max),main="Indel Densities 2kb up from PCOs",xlab ="Distance from midpoint", ylab="Indel Density (indels/bp)")
    lines(smooth.spline(seq(-1000,999,100),test2,spar=0.6),col="blue",lwd=1,type="l",ylim=c(),main="Indel Densities 2kb up from PCOs",xlab ="Distance from midpoint", ylab="Indel Density (indels/bp)")
