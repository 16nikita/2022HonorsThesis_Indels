...
{
  intersect_pred<-read.delim("intersect_aL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_pred<-read.delim("intersect_10bp_aL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_pred<-read.delim("intersect_20bp_aL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_pred<-read.delim("intersect_30bp_aL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_pred<-read.delim("intersect_40bp_aL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_pred<-read.delim("intersect_50bp_aL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_2kbup_pred<-read.delim("intersect_2kbup_aL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_2kbup_pred<-read.delim("intersect_10bp_2kbup_aL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_2kbup_pred<-read.delim("intersect_20bp_2kbup_aL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_2kbup_pred<-read.delim("intersect_30bp_2kbup_aL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_2kbup_pred<-read.delim("intersect_40bp_2kbup_aL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_2kbup_pred<-read.delim("intersect_50bp_2kbup_aL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_2kbdown_pred<-read.delim("intersect_2kbdown_aL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_2kbdown_pred<-read.delim("intersect_10bp_2kbdown_aL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_2kbdown_pred<-read.delim("intersect_20bp_2kbdown_aL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_2kbdown_pred<-read.delim("intersect_30bp_2kbdown_aL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_2kbdown_pred<-read.delim("intersect_40bp_2kbdown_aL_PCO.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_2kbdown_pred<-read.delim("intersect_50bp_2kbdown_aL_PCO.txt",sep='\t', header = FALSE)
...
{
  intersect_cold_pred<-read.delim("intersect_aL_randPCO.txt",sep='\t', header = FALSE)[-c(7:8)]
  ...
  intersect_10bp_cold_pred<-read.delim("intersect_10bp_aL_randPCO.txt",sep='\t', header = FALSE)[-c(7:8)]
  ...
  intersect_20bp_cold_pred<-read.delim("intersect_20bp_aL_randPCO.txt",sep='\t', header = FALSE)[-c(7:8)]
  ...
  intersect_30bp_cold_pred<-read.delim("intersect_30bp_aL_randPCO.txt",sep='\t', header = FALSE)[-c(7:8)]
  ...
  #no data?
  intersect_40bp_cold_pred<-read.delim("intersect_40bp_aL_randPCO.txt",sep='\t', header = FALSE)[-c(7:8)]
  ...
  intersect_50bp_cold_pred<-read.delim("intersect_50bp_aL_randPCO.txt",sep='\t', header = FALSE)[-c(7:8)]
  ...
  intersect_2kbup_cold_pred<-read.delim("intersect_2kbup_aL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_2kbup_cold_pred<-read.delim("intersect_10bp_2kbup_aL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_2kbup_cold_pred<-read.delim("intersect_20bp_2kbup_aL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_2kbup_cold_pred<-read.delim("intersect_30bp_2kbup_aL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_2kbup_cold_pred<-read.delim("intersect_40bp_2kbup_aL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_2kbup_cold_pred<-read.delim("intersect_50bp_2kbup_aL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_2kbdown_cold_pred<-read.delim("intersect_2kbdown_aL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_2kbdown_cold_pred<-read.delim("intersect_10bp_2kbdown_aL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_2kbdown_cold_pred<-read.delim("intersect_20bp_2kbdown_aL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_2kbdown_cold_pred<-read.delim("intersect_30bp_2kbdown_aL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_2kbdown_cold_pred<-read.delim("intersect_40bp_2kbdown_aL_randPCO.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_2kbdown_cold_pred<-read.delim("intersect_50bp_2kbdown_aL_randPCO.txt",sep='\t', header = FALSE)
...
#BARGRAPHS - for each: change TITLE, INDEL SIZES, LEGEND, AXIS TITLE POSITION
{
  ...
  perc<-ggplot(full_data1, aes(fill=color,x=levels,y=value)) +
    ...
    ggtitle("Large Indel Density on Empirical COs") +
...
write.table(test_2,file="PCOs_aL_output.txt",row.names = T,quote=FALSE, sep = '\t')
...
perc<-ggplot(data, aes(fill=intersect,x=reorder(type, value),y=value)) +
  ...
  ggtitle("Indel Density \nOn PCOs Per Chromosome",subtitle = "Average Density: 0.26") +
...
}
{
  ...
  plot (smooth.spline(seq(-5000,4999,100),mean_all_2,spar=0.3),col="red",lwd=3,type="l",xlab ="Distance from midpoint of PCOs", ylab="Indel Density (indels/bp)")
