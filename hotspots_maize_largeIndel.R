...
{
  intersect_pred<-read.delim("intersect_sub_large_hotspot.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_pred<-read.delim("intersect_10bp_sub_large_hotspot.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_pred<-read.delim("intersect_20bp_sub_large_hotspot.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_pred<-read.delim("intersect_30bp_sub_large_hotspot.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_pred<-read.delim("intersect_40bp_sub_large_hotspot.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_pred<-read.delim("intersect_50bp_sub_large_hotspot.txt",sep='\t', header = FALSE)
  ...
  intersect_2kbup_pred<-read.delim("intersect_2kbup_sub_large_hotspot.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_2kbup_pred<-read.delim("intersect_10bp_2kbup_sub_large_hotspot.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_2kbup_pred<-read.delim("intersect_20bp_2kbup_sub_large_hotspot.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_2kbup_pred<-read.delim("intersect_30bp_2kbup_sub_large_hotspot.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_2kbup_pred<-read.delim("intersect_40bp_2kbup_sub_large_hotspot.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_2kbup_pred<-read.delim("intersect_50bp_2kbup_sub_large_hotspot.txt",sep='\t', header = FALSE)
  ...
  intersect_2kbdown_pred<-read.delim("intersect_2kbdown_sub_large_hotspot.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_2kbdown_pred<-read.delim("intersect_10bp_2kbdown_sub_large_hotspot.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_2kbdown_pred<-read.delim("intersect_20bp_2kbdown_sub_large_hotspot.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_2kbdown_pred<-read.delim("intersect_30bp_2kbdown_sub_large_hotspot.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_2kbdown_pred<-read.delim("intersect_40bp_2kbdown_sub_large_hotspot.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_2kbdown_pred<-read.delim("intersect_50bp_2kbdown_sub_large_hotspot.txt",sep='\t', header = FALSE)
...
{
  intersect_cold_pred<-read.delim("intersect_sub_large_coldspot.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_cold_pred<-read.delim("intersect_10bp_sub_large_coldspot.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_cold_pred<-read.delim("intersect_20bp_sub_large_coldspot.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_cold_pred<-read.delim("intersect_30bp_sub_large_coldspot.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_cold_pred<-read.delim("intersect_40bp_sub_large_coldspot.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_cold_pred<-read.delim("intersect_50bp_sub_large_coldspot.txt",sep='\t', header = FALSE)
  ...
  intersect_2kbup_cold_pred<-read.delim("intersect_2kbup_sub_large_coldspot.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_2kbup_cold_pred<-read.delim("intersect_10bp_2kbup_sub_large_coldspot.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_2kbup_cold_pred<-read.delim("intersect_20bp_2kbup_sub_large_coldspot.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_2kbup_cold_pred<-read.delim("intersect_30bp_2kbup_sub_large_coldspot.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_2kbup_cold_pred<-read.delim("intersect_40bp_2kbup_sub_large_coldspot.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_2kbup_cold_pred<-read.delim("intersect_50bp_2kbup_sub_large_coldspot.txt",sep='\t', header = FALSE)
  ...
  intersect_2kbdown_cold_pred<-read.delim("intersect_2kbdown_sub_large_coldspot.txt",sep='\t', header = FALSE)
  ...
  intersect_10bp_2kbdown_cold_pred<-read.delim("intersect_10bp_2kbdown_sub_large_coldspot.txt",sep='\t', header = FALSE)
  ...
  intersect_20bp_2kbdown_cold_pred<-read.delim("intersect_20bp_2kbdown_sub_large_coldspot.txt",sep='\t', header = FALSE)
  ...
  intersect_30bp_2kbdown_cold_pred<-read.delim("intersect_30bp_2kbdown_sub_large_coldspot.txt",sep='\t', header = FALSE)
  ...
  intersect_40bp_2kbdown_cold_pred<-read.delim("intersect_40bp_2kbdown_sub_large_coldspot.txt",sep='\t', header = FALSE)
  ...
  intersect_50bp_2kbdown_cold_pred<-read.delim("intersect_50bp_2kbdown_sub_large_coldspot.txt",sep='\t', header = FALSE)
...
intersect_2kbup_overlap<-percentage_overlap(intersect_2kbup_pred,hotspot_2kb_up)
intersect_10bp_2kbup_overlap<-percentage_overlap(intersect_10bp_2kbup_pred,hotspot_2kb_up)
intersect_20bp_2kbup_overlap<-percentage_overlap(intersect_20bp_2kbup_pred,hotspot_2kb_up)
intersect_30bp_2kbup_overlap<-percentage_overlap(intersect_30bp_2kbup_pred,hotspot_2kb_up)
intersect_40bp_2kbup_overlap<-percentage_overlap(intersect_40bp_2kbup_pred,hotspot_2kb_up)
intersect_50bp_2kbup_overlap<-percentage_overlap(intersect_50bp_2kbup_pred,hotspot_2kb_up)

intersect_2kbdown_overlap<-percentage_overlap(intersect_2kbdown_pred,hotspot_2kb_down)
intersect_10bp_2kbdown_overlap<-percentage_overlap(intersect_10bp_2kbdown_pred,hotspot_2kb_down)
intersect_20bp_2kbdown_overlap<-percentage_overlap(intersect_20bp_2kbdown_pred,hotspot_2kb_down)
intersect_30bp_2kbdown_overlap<-percentage_overlap(intersect_30bp_2kbdown_pred,hotspot_2kb_down)
intersect_40bp_2kbdown_overlap<-percentage_overlap(intersect_40bp_2kbdown_pred,hotspot_2kb_down)
intersect_50bp_2kbdown_overlap<-percentage_overlap(intersect_50bp_2kbdown_pred,hotspot_2kb_down)
...
temp<-rbind(intersect_overlap,intersect_2kbdown_overlap,intersect_2kbdown_overlap)
}
#overlap % stats:
{
  {
...
#BARGRAPHS - for each: change TITLE, INDEL SIZES, LEGEND, AXIS TITLE POSITION
{
  ...
  perc<-ggplot(full_data1, aes(fill=color,x=levels,y=value)) +
    ...
    ggtitle("Large Indel Density on CO Hotspots") +
...
write.table(test_2,file="hotspot_aL_output.txt",row.names = T,quote=FALSE, sep = '\t')
...
perc<-ggplot(data, aes(fill=intersect,x=reorder(type, value),y=value)) +
  ...
  ggtitle("Insertion Density (indels/bp) \nOn Hotspots Per Chromosome",subtitle = "Average Density: .0035") +
...
perc
ggsave("indel_density_hotspot_insertion.pdf", width = 20, height = 10)
perc_cold<-ggplot(data_cold, aes(fill=intersect,x=reorder(type, value),y=value)) +
  ...
  xlab("Type")+guides(fill=guide_legend("Type of intersection"))
perc_cold
ggsave("indel_density_coldspot_insertion.pdf", width = 20, height = 10)
